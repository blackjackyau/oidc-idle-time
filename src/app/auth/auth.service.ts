...
export class OidcAuthService {
    ...
    constructor(@Inject(OidcConfigService) private config: OidcConfig,
        ...
        this.authService.events.addUserSignedOut(() => {
            console.log("User Signout detected");
        });

        this.authService.events.addAccessTokenExpiring(() => {
            console.log("Token Expiring detected");
        });

        this.authService.events.addAccessTokenExpired(() => {
    ...
    public accessTokenisExpired() {
        return this.currentUser.expired;
    }
